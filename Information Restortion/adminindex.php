...
<head>
	...
	<div class="row">
		...
		<div class="col">
		<h5 style="font-family: 'Quicksand', sans-serif;">Add File</h5>
		<a href="add.php"><button style="width: 200px; height: 200px;" type="button" class="btn btn-light"><i class="fa fa-plus" aria-hidden="true" style="font-size:80px"></i></button></a>
		</div>

		<div class="col">
		<h5 style="font-family: 'Quicksand', sans-serif;">Remove File</h5>
		<a href="remove.php"><button style="width: 200px; height: 200px;" type="button" class="btn btn-light"><i class="fa fa-remove" aria-hidden="true" style="font-size:80px"></i></button></a>
		</div>
