...
if(mysqli_connect_errno()) {
  ...
  mysqli_free_result($result);
    ...
    if (isset($_POST['submit'])) {
        ...
        header('LOCATION: eventlist.php?id=' . $tempID . '&kind=1');
    }
?>
...
<body id="wrapperGlobal">
    ...
    <main>
        ...
        <section id="chooseEvent4">
            <h5 class="underline"> בחר\י את האירוע שברצונך להוסיף </h5>
            <form method="post">
                <label class="container">
                    <a href="specialmessage.php?id=<?php echo $row['kid_id']; ?>&kind=1" target="_self">הזן הודעה מותאמת אישית</a>
